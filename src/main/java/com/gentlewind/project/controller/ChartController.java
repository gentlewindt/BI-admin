...
import com.gentlewind.project.bimq.BiMessageProducer;
...
import static com.gentlewind.project.common.ErrorCode.NOT_FOUND_ERROR;
import static com.gentlewind.project.constant.RedisConstant.*;
...
public class ChartController {
    ...
    public BaseResponse<Page<Chart>> listChartByPage(@RequestBody ChartQueryRequest chartQueryRequest, HttpServletRequest request) {
        ...
        Page<Chart> result = chartService.getChartPageByRedis(chartQueryRequest);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Page<Chart>> listMyChartByPage(@RequestBody ChartQueryRequest chartQueryRequest,
        ...
        Page<Chart> chartPage = chartService.page(new Page<>(pageNum, pageSize),
